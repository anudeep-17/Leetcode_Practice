...
| 4 | Longest Common Prefix | [Java](https://github.com/anudeep-17/Leetcode_DS-ALGO_2023/blob/b95392128c4930a53649808813eace11502e768d/Longest%20Common%20Prefix) | Select the first string from the array of strings and call this the prefix. Then keep checking if the index of this prefix is 0 in 1 string of the strings one by one. After the for loop, you'll have the prefix. | [Longest Common Prefix on Leetcode](https://leetcode.com/problems/longest-common-prefix/) |
